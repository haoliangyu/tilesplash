...
Tilesplash.prototype.layer = function(name){
  ...
  this.server.get('/'+name+'/:z/:x/:y.:ext', function(req, res, throwError){
    ...
    render.query = function(data, postQuery){
      gotTile(data, postQuery);
    };
    ...
    var runQuery = function(structuredSql, postQuery, done){
    ...
    var gotTile = function(tileOutput, postQuery){
      ...
      parseSql(tileOutput, function(parsingError, structuredSql){
        ...
        if (cacher) {
          ...
          self._cache(cacheKey, ttl, function(done){
            ...
            runQuery(structuredSql, postQuery, function(queryError, layers){
